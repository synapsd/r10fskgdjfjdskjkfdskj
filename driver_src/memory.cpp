...
#define warriorz_rw CTL_CODE(FILE_DEVICE_UNKNOWN, 0x7B456, METHOD_BUFFERED, FILE_SPECIAL_ACCESS)
#define warriorz_ba CTL_CODE(FILE_DEVICE_UNKNOWN, 0x3C568, METHOD_BUFFERED, FILE_SPECIAL_ACCESS)
...
NTSTATUS LHinitialize_driver(PDRIVER_OBJECT drv_obj, PUNICODE_STRING path) {
	...
	RtlInitUnicodeString(&LHname, L"\\Device\\");
	RtlInitUnicodeString(&LHlink, L"\\DosDevices\\");
